...
export class PyodideRemoteKernel {
    ...
    protected async initRuntime(options: IPyodideWorkerKernel.IOptions): Promise<void> {
        ...
        const loadPyodide = pyodideModule.loadPyodide || (pyodideModule as any).default.loadPyodide;
     ...
     */
    async commInfo(content: any, parent: any): Promise<KernelMessage.ICommInfoReplyMsg['content']> {
        await this.setup(parent);
